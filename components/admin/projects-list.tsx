  ...
  return (
    <>
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="mt-5 flex gap-2">
                ...
                <AdminButton variant="danger" onClick={() => setPendingId(project.id)}>
                  Delete
                </AdminButton>
              </div>
            </div>
      ...
      <ConfirmDialog
        ...
        description={
          pending
            ? `“${pending.title}” will be permanently removed from the portfolio.`
            : "This project will be permanently removed from the portfolio."
        }
